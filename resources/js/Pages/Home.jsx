    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center gap-12 px-6">
            <section className="text-center">
                <p className="mb-3 text-sm font-medium uppercase tracking-widest text-cyan-400">nelsonlys.com</p>
                <h1 className="bg-gradient-to-r from-cyan-400 via-sky-400 to-violet-400 bg-clip-text text-6xl font-extrabold text-transparent">
                    hello {name}
                </h1>
